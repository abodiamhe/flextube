...
// app.get("/video", async (req, res) => {
//     const videoId = req.query.id;
//     const range = req.headers.range; // Get Range from client
...
//       responseType: "stream",
//       headers: {
//         Range: range, // Forward Range header to storage service
//       },
//     });

//     res.status(response.status); // Usually 206 for partial
//     res.set({
