...
console.log(
  `Serving videos from Azure storage account ${STORAGE_ACCOUNT_NAME}/${STORAGE_CONTAINER_NAME}.`
);
...
//     response.readableStreamBody.pipe(res);
//   } else {
//     // Range header exists: parse it
//     const [startStr, endStr] = range.replace(/bytes=/, "").split("-");
//     const start = parseInt(startStr, 10);
//     const end = endStr ? parseInt(endStr, 10) : properties.contentLength - 1;
